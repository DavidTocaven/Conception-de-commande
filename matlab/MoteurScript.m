clear all
close all
PLOT = 0; % si 0 pas de plot, si 1 plot
...
TFmoteurConnaissanceVmOmega = tf(Kc,[L*J2, mu*L+R*J2, Ke*Kc+mu*R]); % ordre 2
% Fonction de transfert Tension / Vg
TFmoteurConnaissanceVmVg = tf(Kc*Kg,[L*J2, mu*L+R*J2, Ke*Kc+mu*R]); % ordre 2
% Fonction de transfert Tension / Vs
TFmoteurConnaissanceVmVs = tf(Kc*Kr*Ks,[L*J2, mu*L+R*J2, Ke*Kc+mu*R, 0]); % ordre 3
%%
...
%% MODELE EE1 -- taille 3 (Vm,i1,omega)
...
%% MODELE EE2 -- taille 4 (i1,i2,Vm,omega)
%%% Modele espace d'état LINEAIRE
