...
MODEL                = SimuDemonstrateurMoteur
MODULES              = SimuDemonstrateurMoteur_data.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c 
MAKEFILE             = SimuDemonstrateurMoteur.mk
...
MASTER_ANCHOR_DIR    = 
START_DIR            = C:\DOCUME~1\M2ISTR~1\Bureau\POURET~1
S_FUNCTIONS          = ModeleDemonstrateurMoteur_wrapper.c
S_FUNCTIONS_LIB      = 
SOLVER               = 
NUMST                = 2
TID01EQ              = 1
...
MODELLIB                  = SimuDemonstrateurMoteurlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = SimuDemonstrateurMoteur_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\SimuDemonstrateurMoteur_grt_rtw
