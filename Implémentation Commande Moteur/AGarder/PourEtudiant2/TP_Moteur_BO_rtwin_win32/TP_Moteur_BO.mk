...
MODEL                := TP_Moteur_BO
MODULES              := TP_Moteur_BO_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             := TP_Moteur_BO.mk
...
#
MODELLIB                  := TP_Moteur_BOlib_rtwin.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := TP_Moteur_BO_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES := $(REQ_INCLUDES);C:/DOCUME~1/M2ISTR~1/Bureau/POURET~1/TP_Moteur_BO_rtwin_win32;C:/DOCUME~1/M2ISTR~1/Bureau/POURET~1;C:/DOCUME~1/M2ISTR~1/Bureau/POURET~1/Moteur_Etudiant
