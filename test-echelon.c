...
*/
static float my0 =  1.474124;
static float my1 =  -2.818532;
static float my2 =  1.347227;

static float d1 =  1.000000;
static float d2 =  -1.864621;

static float mu0 =  -0.000019;
static float mu1 =  0.000000;
static float mu2 =  0.000019;
...
void acquisition_adc() {
  ...
  /* Adaptation de la sortie [0;5] vers CNA [2048;4095] */
  V_cna0 = (int)(2047.0/5.0*((s0 + 5.0)/2.0)+2048.0);
  //V_cna0 = V_cna0/10;
  ...
  printf_entier_console("Consigne = %u ", consigne);
  //printf_entier_console("CAN = %d ", V_can0);
